...
ai_question_answer_task = None
python_expert_agent = None
python_question_answer_task = None
...
def create_crew(ai_expert_agent, ai_question_answer_task, python_expert_agent, python_question_answer_task):
    print("create_crew START")
    crew = Crew(
        agents=[ai_expert_agent, python_expert_agent],
        tasks=[ai_question_answer_task, python_question_answer_task],
...
def main():
    global crew, ai_expert_agent, ai_question_answer_task, python_expert_agent, python_question_answer_task
    docs = upload_documents()

    for doc in docs:
        if re.search("Coding In Python", doc):
            python_expert_agent = agent.get_python_expert_agent(doc)
            python_question_answer_task = task.create_python_question_answer_task(python_expert_agent, doc)
            ...
            ai_question_answer_task = task.create_ai_question_answer_task(ai_expert_agent, doc)
...
if __name__ == "__main__":
    ...
    if question:
        ...
        if ai_expert_agent and ai_question_answer_task and python_expert_agent and python_question_answer_task:
            crew = create_crew(ai_expert_agent, ai_question_answer_task, python_expert_agent, python_question_answer_task)
